import { f as f$1, B, E, x, T } from './directive-helpers-D239ud1A.js';
 ...
 */
const t={ATTRIBUTE:1,CHILD:2},e$1=t=>(...e)=>({_$litDirective$:t,values:e});let i$2 = class i{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i;}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};

/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const s=(i,t)=>{const e=i._$AN;if(void 0===e)return  false;for(const i of e)i._$AO?.(t,false),s(i,t);return  true},o$4=i=>{let t,e;do{if(void 0===(t=i._$AM))break;e=t._$AN,e.delete(i),i=t;}while(0===e?.size)},r=i=>{for(let t;t=i._$AM;i=t){let e=t._$AN;if(void 0===e)t._$AN=e=new Set;else if(e.has(i))break;e.add(i),c(t);}};function h(i){ void 0!==this._$AN?(o$4(this),this._$AM=i,r(this)):this._$AM=i;}function n$3(i,t=false,e=0){const r=this._$AH,h=this._$AN;if(void 0!==h&&0!==h.size)if(t)if(Array.isArray(r))for(let i=e;i<r.length;i++)s(r[i],false),o$4(r[i]);else null!=r&&(s(r,false),o$4(r));else s(this,i);}const c=i=>{i.type==t.CHILD&&(i._$AP??=n$3,i._$AQ??=h);};class f extends i$2{constructor(){super(...arguments),this._$AN=void 0;}_$AT(i,t,e){super._$AT(i,t,e),r(this),this.isConnected=i._$AU;}_$AO(i,t=true){i!==this.isConnected&&(this.isConnected=i,i?this.reconnected?.():this.disconnected?.()),t&&(s(this,i),o$4(this));}setValue(t){if(f$1(this._$Ct))this._$Ct._$AI(t,this);else {const i=[...this._$Ct._$AH];i[this._$Ci]=t,this._$Ct._$AI(i,this,0);}}disconnected(){}reconnected(){}}
...
var style$4 = document.createElement('style');
style$4.textContent = '[hidden] { display: none !important; }';
document.head.appendChild(style$4);
...
const constUndefined = constant(), noop = constUndefined;

const Keybindings = createContext(() => noop);
...
const useActivity = (handler, deps) => {
...
customElements.define('cosmoz-dropdown-list', component(List, { styleSheets: [style$3] }));
...
const o$1=new WeakMap,n$1=e$1(class extends f{render(i){return E}update(i,[s]){const e=s!==this.G;return e&&void 0!==this.G&&this.rt(void 0),(e||this.lt!==this.ct)&&(this.G=s,this.ht=i.options?.host,this.rt(this.ct=i.element)),E}rt(t){if(this.isConnected||(t=void 0),"function"==typeof this.G){const i=this.ht??globalThis;let s=o$1.get(i);void 0===s&&(s=new WeakMap,o$1.set(i,s)),void 0!==s.get(this.G)&&this.G.call(this.ht,void 0),s.set(this.G,t),void 0!==t&&this.G.call(this.ht,t);}else this.G.value=t;}get lt(){return "function"==typeof this.G?o$1.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0);}reconnected(){this.rt(this.ct);}});
...
customElements.define('cosmoz-dropdown-content', connectable(component(Content, { styleSheets: [style$2] })));
...
const Dropdown = (host) => {
    ...
    return x ` <div class="anchor" part="anchor" ${n$1(setReference)}>
		...
		${n$2(active, () => x `<cosmoz-dropdown-content
					popover
					id="content"
					part="content"
					...
					${n$1(setFloating)}
					><slot></slot>${i([render], () => render?.() || E)}</cosmoz-dropdown-content
				> `)}`;
};
customElements.define('cosmoz-dropdown', component(Dropdown, { styleSheets: [style$1] }));
...
class OverflowDirective extends f {
  constructor() {
    super(...arguments);
...
const overflow = e$1(OverflowDirective);
...
const openActionsMenu = (host) => {
  ...
  const cosmozDropdown = dropdown.shadowRoot?.querySelector("cosmoz-dropdown"), button = cosmozDropdown?.shadowRoot?.querySelector(
    "#dropdownButton"
  );
  button?.click();
};
const useMenuButtons = (host) => {
  ...
  const menuButtons = useMemo(
    () => processedButtons.slice(toolbarLimit).sort(
      (a, b) => b.element.compareDocumentPosition(a.element) - a.element.compareDocumentPosition(b.element)
    ),
    [processedButtons, toolbarLimit]
  );
  useEffect(() => {
...
`;
x(Object.assign([tmplt], { raw: [tmplt] })); html(Object.assign([tmplt], { raw: [tmplt] }));
...
const CosmozBottomBarStory = (host) => {
  ...
  return x`
		<input
			...
			type="number"
			@input=${handleInput}
			@keypress=${(e) => e.key === "Enter" && addButton(inputValue)}
		/>
		<paper-button @click=${() => addButton(inputValue)}>Add btn</paper-button>
		<paper-button @click=${() => addButton(void 0)}
    ...
    (btn) => x`<paper-button
						@click=${btn.onClick}
						data-priority=${o$3(btn.priority)}
...
const CosmozBottomBarTemplate = (args) => x`<cosmoz-bottom-bar-story
		?active=${args.active}
...
const __namedExportsOrder = ["Basic", "Empty"];

export { Basic, Empty, __namedExportsOrder, meta as default };
