...
`,qc=()=>M` <slot></slot> `;customElements.define("cosmoz-dropdown-list",ve(qc,{styleSheets:[Vc]}));const Yc=({placement:e})=>M` <cosmoz-dropdown
	...
	</cosmoz-dropdown>`;customElements.define("cosmoz-dropdown-menu",ve(Yc));const Wc={},Jc=Mt(class extends Pi{constructor(){super(...arguments),this.ot=Wc}render(e,t){return t()}update(e,[t,i]){if(Array.isArray(t)){if(Array.isArray(this.ot)&&this.ot.length===t.length&&t.every((n,s)=>n===this.ot[s]))return He}else if(this.ot===t)return He;return this.ot=Array.isArray(t)?Array.from(t):t,this.render(t,i)}}),ti=new WeakMap,sn=Mt(class extends bn{render(e){return dt}update(e,[t]){const i=t!==this.G;return i&&this.G!==void 0&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),dt}rt(e){if(this.isConnected||(e=void 0),typeof this.G=="function"){const t=this.ht??globalThis;let i=ti.get(t);i===void 0&&(i=new WeakMap,ti.set(t,i)),i.get(this.G)!==void 0&&this.G.call(this.ht,void 0),i.set(this.G,e),e!==void 0&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return typeof this.G=="function"?ti.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});const Dr="important",Gc=" !"+Dr,Xc=Mt(class extends Pi{constructor(e){if(super(e),e.type!==yn.ATTRIBUTE||e.name!=="style"||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,i)=>{const n=e[i];return n==null?t:t+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${n};`},"")}update(e,[t]){const{style:i}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(const n of this.ft)t[n]==null&&(this.ft.delete(n),n.includes("-")?i.removeProperty(n):i[n]=null);for(const n in t){const s=t[n];if(s!=null){this.ft.add(n);const r=typeof s=="string"&&s.endsWith(Gc);n.includes("-")||r?i.setProperty(n,r?s.slice(0,-11):s,r?Dr:""):i[n]=s}}return He}});function Qc(e,t,i){return e?t(e):i?.(e)}const Zc=(e=HTMLElement)=>class extends e{connectedCallback(){super.connectedCallback?.(),this.dispatchEvent(new CustomEvent("connected"))}disconnectedCallback(){super.disconnectedCallback?.(),this.dispatchEvent(new CustomEvent("disconnected"))}},eu=Nt`
	:host {
		position: fixed;
		left: -9999999999px;
		min-width: 72px;
...
`,tu=()=>M`<div class="wrap" part="wrap"><slot></slot></div>`;customElements.define("cosmoz-dropdown-content",Zc(ve(tu,{styleSheets:[eu]})));const Et=Math.min,ne=Math.max,At=Math.round,nt=Math.floor,B=e=>({x:e,y:e}),iu={left:"right",right:"left",bottom:"top",top:"bottom"},su={start:"end",end:"start"};function nn(e,t,i){return ne(e,Et(t,i))}function Vi(e,t){return typeof e=="function"?e(t):e}function be(e){return e.split("-")[0]}function qi(e){return e.split("-")[1]}function Ir(e){return e==="x"?"y":"x"}function Lr(e){return e==="y"?"height":"width"}const nu=new Set(["top","bottom"]);function Z(e){return nu.has(be(e))?"y":"x"}function Br(e){return Ir(Z(e))}function ru(e,t,i){i===void 0&&(i=!1);const n=qi(e),s=Br(e),r=Lr(s);let o=s==="x"?n===(i?"end":"start")?"right":"left":n==="start"?"bottom":"top";return t.reference[r]>t.floating[r]&&(o=Tt(o)),[o,Tt(o)]}function ou(e){const t=Tt(e);return[xi(e),t,xi(t)]}function xi(e){return e.replace(/start|end/g,t=>su[t])}const rn=["left","right"],on=["right","left"],au=["top","bottom"],lu=["bottom","top"];function cu(e,t,i){switch(e){case"top":case"bottom":return i?t?on:rn:t?rn:on;case"left":case"right":return t?au:lu;default:return[]}}function uu(e,t,i,n){const s=qi(e);let r=cu(be(e),i==="start",n);return s&&(r=r.map(o=>o+"-"+s),t&&(r=r.concat(r.map(xi)))),r}function Tt(e){return e.replace(/left|right|bottom|top/g,t=>iu[t])}function du(e){return{top:0,right:0,bottom:0,left:0,...e}}function hu(e){return typeof e!="number"?du(e):{top:e,right:e,bottom:e,left:e}}function Ot(e){const{x:t,y:i,width:n,height:s}=e;return{width:n,height:s,top:i,left:t,right:t+n,bottom:i+s,x:t,y:i}}function an(e,t,i){let{reference:n,floating:s}=e;const r=Z(t),o=Br(t),a=Lr(o),l=be(t),c=r==="y",u=n.x+n.width/2-s.width/2,d=n.y+n.height/2-s.height/2,h=n[a]/2-s[a]/2;let p;switch(l){case"top":p={x:u,y:n.y-s.height};break;case"bottom":p={x:u,y:n.y+n.height};break;case"right":p={x:n.x+n.width,y:d};break;case"left":p={x:n.x-s.width,y:d};break;default:p={x:n.x,y:n.y}}switch(qi(t)){case"start":p[o]-=h*(i&&c?-1:1);break;case"end":p[o]+=h*(i&&c?-1:1);break}return p}const pu=async(e,t,i)=>{const{placement:n="bottom",strategy:s="absolute",middleware:r=[],platform:o}=i,a=r.filter(Boolean),l=await(o.isRTL==null?void 0:o.isRTL(t));let c=await o.getElementRects({reference:e,floating:t,strategy:s}),{x:u,y:d}=an(c,n,l),h=n,p={},f=0;for(let g=0;g<a.length;g++){const{name:y,fn:_}=a[g],{x:b,y:w,data:S,reset:x}=await _({x:u,y:d,initialPlacement:n,placement:h,strategy:s,middlewareData:p,rects:c,platform:o,elements:{reference:e,floating:t}});u=b??u,d=w??d,p={...p,[y]:{...p[y],...S}},x&&f<=50&&(f++,typeof x=="object"&&(x.placement&&(h=x.placement),x.rects&&(c=x.rects===!0?await o.getElementRects({reference:e,floating:t,strategy:s}):x.rects),{x:u,y:d}=an(c,h,l)),g=-1)}return{x:u,y:d,placement:h,strategy:s,middlewareData:p}};async function Fr(e,t){var i;t===void 0&&(t={});const{x:n,y:s,platform:r,rects:o,elements:a,strategy:l}=e,{boundary:c="clippingAncestors",rootBoundary:u="viewport",elementContext:d="floating",altBoundary:h=!1,padding:p=0}=Vi(t,e),f=hu(p),y=a[h?d==="floating"?"reference":"floating":d],_=Ot(await r.getClippingRect({element:(i=await(r.isElement==null?void 0:r.isElement(y)))==null||i?y:y.contextElement||await(r.getDocumentElement==null?void 0:r.getDocumentElement(a.floating)),boundary:c,rootBoundary:u,strategy:l})),b=d==="floating"?{x:n,y:s,width:o.floating.width,height:o.floating.height}:o.reference,w=await(r.getOffsetParent==null?void 0:r.getOffsetParent(a.floating)),S=await(r.isElement==null?void 0:r.isElement(w))?await(r.getScale==null?void 0:r.getScale(w))||{x:1,y:1}:{x:1,y:1},x=Ot(r.convertOffsetParentRelativeRectToViewportRelativeRect?await r.convertOffsetParentRelativeRectToViewportRelativeRect({elements:a,rect:b,offsetParent:w,strategy:l}):b);return{top:(_.top-x.top+f.top)/S.y,bottom:(x.bottom-_.bottom+f.bottom)/S.y,left:(_.left-x.left+f.left)/S.x,right:(x.right-_.right+f.right)/S.x}}const fu=function(e){return e===void 0&&(e={}),{name:"flip",options:e,async fn(t){var i,n;const{placement:s,middlewareData:r,rects:o,initialPlacement:a,platform:l,elements:c}=t,{mainAxis:u=!0,crossAxis:d=!0,fallbackPlacements:h,fallbackStrategy:p="bestFit",fallbackAxisSideDirection:f="none",flipAlignment:g=!0,...y}=Vi(e,t);if((i=r.arrow)!=null&&i.alignmentOffset)return{};const _=be(s),b=Z(a),w=be(a)===a,S=await(l.isRTL==null?void 0:l.isRTL(c.floating)),x=h||(w||!g?[Tt(a)]:ou(a)),Se=f!=="none";!h&&Se&&x.push(...uu(a,g,f,S));const ce=[a,...x],jt=await Fr(t,y),Qe=[];let ue=((n=r.flip)==null?void 0:n.overflows)||[];if(u&&Qe.push(jt[_]),d){const J=ru(s,o,S);Qe.push(jt[J[0]],jt[J[1]])}if(ue=[...ue,{placement:s,overflows:Qe}],!Qe.every(J=>J<=0)){var Gi,Xi;const J=(((Gi=r.flip)==null?void 0:Gi.index)||0)+1,Kt=ce[J];if(Kt&&(!(d==="alignment"?b!==Z(Kt):!1)||ue.every(R=>Z(R.placement)===b?R.overflows[0]>0:!0)))return{data:{index:J,overflows:ue},reset:{placement:Kt}};let Pe=(Xi=ue.filter(G=>G.overflows[0]<=0).sort((G,R)=>G.overflows[1]-R.overflows[1])[0])==null?void 0:Xi.placement;if(!Pe)switch(p){case"bestFit":{var Qi;const G=(Qi=ue.filter(R=>{if(Se){const j=Z(R.placement);return j===b||j==="y"}return!0}).map(R=>[R.placement,R.overflows.filter(j=>j>0).reduce((j,Wr)=>j+Wr,0)]).sort((R,j)=>R[1]-j[1])[0])==null?void 0:Qi[0];G&&(Pe=G);break}case"initialPlacement":Pe=a;break}if(s!==Pe)return{reset:{placement:Pe}}}return{}}}},_u=function(e){return e===void 0&&(e={}),{name:"shift",options:e,async fn(t){const{x:i,y:n,placement:s}=t,{mainAxis:r=!0,crossAxis:o=!1,limiter:a={fn:y=>{let{x:_,y:b}=y;return{x:_,y:b}}},...l}=Vi(e,t),c={x:i,y:n},u=await Fr(t,l),d=Z(be(s)),h=Ir(d);let p=c[h],f=c[d];if(r){const y=h==="y"?"top":"left",_=h==="y"?"bottom":"right",b=p+u[y],w=p-u[_];p=nn(b,p,w)}if(o){const y=d==="y"?"top":"left",_=d==="y"?"bottom":"right",b=f+u[y],w=f-u[_];f=nn(b,f,w)}const g=a.fn({...t,[h]:p,[d]:f});return{...g,data:{x:g.x-i,y:g.y-n,enabled:{[h]:r,[d]:o}}}}}};function zt(){return typeof window<"u"}function xe(e){return zr(e)?(e.nodeName||"").toLowerCase():"#document"}function k(e){var t;return(e==null||(t=e.ownerDocument)==null?void 0:t.defaultView)||window}function z(e){var t;return(t=(zr(e)?e.ownerDocument:e.document)||window.document)==null?void 0:t.documentElement}function zr(e){return zt()?e instanceof Node||e instanceof k(e).Node:!1}function D(e){return zt()?e instanceof Element||e instanceof k(e).Element:!1}function F(e){return zt()?e instanceof HTMLElement||e instanceof k(e).HTMLElement:!1}function ln(e){return!zt()||typeof ShadowRoot>"u"?!1:e instanceof ShadowRoot||e instanceof k(e).ShadowRoot}const mu=new Set(["inline","contents"]);function Xe(e){const{overflow:t,overflowX:i,overflowY:n,display:s}=I(e);return/auto|scroll|overlay|hidden|clip/.test(t+n+i)&&!mu.has(s)}const yu=new Set(["table","td","th"]);function gu(e){return yu.has(xe(e))}const bu=[":popover-open",":modal"];function Ht(e){return bu.some(t=>{try{return e.matches(t)}catch{return!1}})}const wu=["transform","translate","scale","rotate","perspective"],vu=["transform","translate","scale","rotate","perspective","filter"],Cu=["paint","layout","strict","content"];function Yi(e){const t=Wi(),i=D(e)?I(e):e;return wu.some(n=>i[n]?i[n]!=="none":!1)||(i.containerType?i.containerType!=="normal":!1)||!t&&(i.backdropFilter?i.backdropFilter!=="none":!1)||!t&&(i.filter?i.filter!=="none":!1)||vu.some(n=>(i.willChange||"").includes(n))||Cu.some(n=>(i.contain||"").includes(n))}function xu(e){let t=Y(e);for(;F(t)&&!we(t);){if(Yi(t))return t;if(Ht(t))return null;t=Y(t)}return null}function Wi(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}const Su=new Set(["html","body","#document"]);function we(e){return Su.has(xe(e))}function I(e){return k(e).getComputedStyle(e)}function $t(e){return D(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function Y(e){if(xe(e)==="html")return e;const t=e.assignedSlot||e.parentNode||ln(e)&&e.host||z(e);return ln(t)?t.host:t}function Hr(e){const t=Y(e);return we(t)?e.ownerDocument?e.ownerDocument.body:e.body:F(t)&&Xe(t)?t:Hr(t)}function Je(e,t,i){var n;t===void 0&&(t=[]),i===void 0&&(i=!0);const s=Hr(e),r=s===((n=e.ownerDocument)==null?void 0:n.body),o=k(s);if(r){const a=Si(o);return t.concat(o,o.visualViewport||[],Xe(s)?s:[],a&&i?Je(a):[])}return t.concat(s,Je(s,[],i))}function Si(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function $r(e){const t=I(e);let i=parseFloat(t.width)||0,n=parseFloat(t.height)||0;const s=F(e),r=s?e.offsetWidth:i,o=s?e.offsetHeight:n,a=At(i)!==r||At(n)!==o;return a&&(i=r,n=o),{width:i,height:n,$:a}}function Ji(e){return D(e)?e:e.contextElement}function me(e){const t=Ji(e);if(!F(t))return B(1);const i=t.getBoundingClientRect(),{width:n,height:s,$:r}=$r(t);let o=(r?At(i.width):i.width)/n,a=(r?At(i.height):i.height)/s;return(!o||!Number.isFinite(o))&&(o=1),(!a||!Number.isFinite(a))&&(a=1),{x:o,y:a}}const Pu=B(0);function Ur(e){const t=k(e);return!Wi()||!t.visualViewport?Pu:{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}}function Eu(e,t,i){return t===void 0&&(t=!1),!i||t&&i!==k(e)?!1:t}function oe(e,t,i,n){t===void 0&&(t=!1),i===void 0&&(i=!1);const s=e.getBoundingClientRect(),r=Ji(e);let o=B(1);t&&(n?D(n)&&(o=me(n)):o=me(e));const a=Eu(r,i,n)?Ur(r):B(0);let l=(s.left+a.x)/o.x,c=(s.top+a.y)/o.y,u=s.width/o.x,d=s.height/o.y;if(r){const h=k(r),p=n&&D(n)?k(n):n;let f=h,g=Si(f);for(;g&&n&&p!==f;){const y=me(g),_=g.getBoundingClientRect(),b=I(g),w=_.left+(g.clientLeft+parseFloat(b.paddingLeft))*y.x,S=_.top+(g.clientTop+parseFloat(b.paddingTop))*y.y;l*=y.x,c*=y.y,u*=y.x,d*=y.y,l+=w,c+=S,f=k(g),g=Si(f)}}return Ot({width:u,height:d,x:l,y:c})}function Ut(e,t){const i=$t(e).scrollLeft;return t?t.left+i:oe(z(e)).left+i}function jr(e,t){const i=e.getBoundingClientRect(),n=i.left+t.scrollLeft-Ut(e,i),s=i.top+t.scrollTop;return{x:n,y:s}}function Au(e){let{elements:t,rect:i,offsetParent:n,strategy:s}=e;const r=s==="fixed",o=z(n),a=t?Ht(t.floating):!1;if(n===o||a&&r)return i;let l={scrollLeft:0,scrollTop:0},c=B(1);const u=B(0),d=F(n);if((d||!d&&!r)&&((xe(n)!=="body"||Xe(o))&&(l=$t(n)),F(n))){const p=oe(n);c=me(n),u.x=p.x+n.clientLeft,u.y=p.y+n.clientTop}const h=o&&!d&&!r?jr(o,l):B(0);return{width:i.width*c.x,height:i.height*c.y,x:i.x*c.x-l.scrollLeft*c.x+u.x+h.x,y:i.y*c.y-l.scrollTop*c.y+u.y+h.y}}function Tu(e){return Array.from(e.getClientRects())}function Ou(e){const t=z(e),i=$t(e),n=e.ownerDocument.body,s=ne(t.scrollWidth,t.clientWidth,n.scrollWidth,n.clientWidth),r=ne(t.scrollHeight,t.clientHeight,n.scrollHeight,n.clientHeight);let o=-i.scrollLeft+Ut(e);const a=-i.scrollTop;return I(n).direction==="rtl"&&(o+=ne(t.clientWidth,n.clientWidth)-s),{width:s,height:r,x:o,y:a}}const cn=25;function ku(e,t){const i=k(e),n=z(e),s=i.visualViewport;let r=n.clientWidth,o=n.clientHeight,a=0,l=0;if(s){r=s.width,o=s.height;const u=Wi();(!u||u&&t==="fixed")&&(a=s.offsetLeft,l=s.offsetTop)}const c=Ut(n);if(c<=0){const u=n.ownerDocument,d=u.body,h=getComputedStyle(d),p=u.compatMode==="CSS1Compat"&&parseFloat(h.marginLeft)+parseFloat(h.marginRight)||0,f=Math.abs(n.clientWidth-d.clientWidth-p);f<=cn&&(r-=f)}else c<=cn&&(r+=c);return{width:r,height:o,x:a,y:l}}const Nu=new Set(["absolute","fixed"]);function Mu(e,t){const i=oe(e,!0,t==="fixed"),n=i.top+e.clientTop,s=i.left+e.clientLeft,r=F(e)?me(e):B(1),o=e.clientWidth*r.x,a=e.clientHeight*r.y,l=s*r.x,c=n*r.y;return{width:o,height:a,x:l,y:c}}function un(e,t,i){let n;if(t==="viewport")n=ku(e,i);else if(t==="document")n=Ou(z(e));else if(D(t))n=Mu(t,i);else{const s=Ur(e);n={x:t.x-s.x,y:t.y-s.y,width:t.width,height:t.height}}return Ot(n)}function Kr(e,t){const i=Y(e);return i===t||!D(i)||we(i)?!1:I(i).position==="fixed"||Kr(i,t)}function Ru(e,t){const i=t.get(e);if(i)return i;let n=Je(e,[],!1).filter(a=>D(a)&&xe(a)!=="body"),s=null;const r=I(e).position==="fixed";let o=r?Y(e):e;for(;D(o)&&!we(o);){const a=I(o),l=Yi(o);!l&&a.position==="fixed"&&(s=null),(r?!l&&!s:!l&&a.position==="static"&&!!s&&Nu.has(s.position)||Xe(o)&&!l&&Kr(e,o))?n=n.filter(u=>u!==o):s=a,o=Y(o)}return t.set(e,n),n}function Du(e){let{element:t,boundary:i,rootBoundary:n,strategy:s}=e;const o=[...i==="clippingAncestors"?Ht(t)?[]:Ru(t,this._c):[].concat(i),n],a=o[0],l=o.reduce((c,u)=>{const d=un(t,u,s);return c.top=ne(d.top,c.top),c.right=Et(d.right,c.right),c.bottom=Et(d.bottom,c.bottom),c.left=ne(d.left,c.left),c},un(t,a,s));return{width:l.right-l.left,height:l.bottom-l.top,x:l.left,y:l.top}}function Iu(e){const{width:t,height:i}=$r(e);return{width:t,height:i}}function Lu(e,t,i){const n=F(t),s=z(t),r=i==="fixed",o=oe(e,!0,r,t);let a={scrollLeft:0,scrollTop:0};const l=B(0);function c(){l.x=Ut(s)}if(n||!n&&!r)if((xe(t)!=="body"||Xe(s))&&(a=$t(t)),n){const p=oe(t,!0,r,t);l.x=p.x+t.clientLeft,l.y=p.y+t.clientTop}else s&&c();r&&!n&&s&&c();const u=s&&!n&&!r?jr(s,a):B(0),d=o.left+a.scrollLeft-l.x-u.x,h=o.top+a.scrollTop-l.y-u.y;return{x:d,y:h,width:o.width,height:o.height}}function ii(e){return I(e).position==="static"}function dn(e,t){if(!F(e)||I(e).position==="fixed")return null;if(t)return t(e);let i=e.offsetParent;return z(e)===i&&(i=i.ownerDocument.body),i}function Vr(e,t){const i=k(e);if(Ht(e))return i;if(!F(e)){let s=Y(e);for(;s&&!we(s);){if(D(s)&&!ii(s))return s;s=Y(s)}return i}let n=dn(e,t);for(;n&&gu(n)&&ii(n);)n=dn(n,t);return n&&we(n)&&ii(n)&&!Yi(n)?i:n||xu(e)||i}const Bu=async function(e){const t=this.getOffsetParent||Vr,i=this.getDimensions,n=await i(e.floating);return{reference:Lu(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:n.width,height:n.height}}};function Fu(e){return I(e).direction==="rtl"}const zu={convertOffsetParentRelativeRectToViewportRelativeRect:Au,getDocumentElement:z,getClippingRect:Du,getOffsetParent:Vr,getElementRects:Bu,getClientRects:Tu,getDimensions:Iu,getScale:me,isElement:D,isRTL:Fu};function qr(e,t){return e.x===t.x&&e.y===t.y&&e.width===t.width&&e.height===t.height}function Hu(e,t){let i=null,n;const s=z(e);function r(){var a;clearTimeout(n),(a=i)==null||a.disconnect(),i=null}function o(a,l){a===void 0&&(a=!1),l===void 0&&(l=1),r();const c=e.getBoundingClientRect(),{left:u,top:d,width:h,height:p}=c;if(a||t(),!h||!p)return;const f=nt(d),g=nt(s.clientWidth-(u+h)),y=nt(s.clientHeight-(d+p)),_=nt(u),w={rootMargin:-f+"px "+-g+"px "+-y+"px "+-_+"px",threshold:ne(0,Et(1,l))||1};let S=!0;function x(Se){const ce=Se[0].intersectionRatio;if(ce!==l){if(!S)return o();ce?o(!1,ce):n=setTimeout(()=>{o(!1,1e-7)},1e3)}ce===1&&!qr(c,e.getBoundingClientRect())&&o(),S=!1}try{i=new IntersectionObserver(x,{...w,root:s.ownerDocument})}catch{i=new IntersectionObserver(x,w)}i.observe(e)}return o(!0),r}function $u(e,t,i,n){n===void 0&&(n={});const{ancestorScroll:s=!0,ancestorResize:r=!0,elementResize:o=typeof ResizeObserver=="function",layoutShift:a=typeof IntersectionObserver=="function",animationFrame:l=!1}=n,c=Ji(e),u=s||r?[...c?Je(c):[],...Je(t)]:[];u.forEach(_=>{s&&_.addEventListener("scroll",i,{passive:!0}),r&&_.addEventListener("resize",i)});const d=c&&a?Hu(c,i):null;let h=-1,p=null;o&&(p=new ResizeObserver(_=>{let[b]=_;b&&b.target===c&&p&&(p.unobserve(t),cancelAnimationFrame(h),h=requestAnimationFrame(()=>{var w;(w=p)==null||w.observe(t)})),i()}),c&&!l&&p.observe(c),p.observe(t));let f,g=l?oe(e):null;l&&y();function y(){const _=oe(e);g&&!qr(g,_)&&i(),g=_,f=requestAnimationFrame(y)}return i(),()=>{var _;u.forEach(b=>{s&&b.removeEventListener("scroll",i),r&&b.removeEventListener("resize",i)}),d?.(),(_=p)==null||_.disconnect(),p=null,l&&cancelAnimationFrame(f)}}const Uu=_u,ju=fu,Ku=(e,t,i)=>{const n=new Map,s={platform:zu,...i},r={...s.platform,_c:n};return pu(e,t,{...s,platform:r})},Vu=[ju({fallbackAxisSideDirection:"start",crossAxis:!1}),Uu()],qu=({placement:e="bottom-start",strategy:t,middleware:i=Vu}={})=>{const[n,s]=ie(),[r,o]=ie(),[a,l]=ie();return te(()=>{if(!n||!(r instanceof HTMLElement)){l(void 0);return}return $u(n,r,()=>Ku(n,r,{placement:e,strategy:t,middleware:i}).then(l))},[n,r,e,t,i]),{setReference:s,setFloating:o,styles:H(()=>a?{left:`${a.x}px`,top:`${a.y}px`}:{},[a?.x,a?.y])}},Yu=e=>e.preventDefault(),Wu=Nt`
	.anchor {
		pointer-events: none;
...
`,Ju=e=>{const{placement:t,strategy:i,middleware:n,render:s}=e,{active:r,onToggle:o}=Kc(e),{styles:a,setReference:l,setFloating:c}=qu({placement:t,strategy:i,middleware:n});return M` <div class="anchor" part="anchor" ${sn(l)}>
		...
		${Qc(r,()=>M`<cosmoz-dropdown-content
					...
					${sn(c)}
					><slot></slot>${Jc([s],()=>s?.()||dt)}</cosmoz-dropdown-content
				> `)}`};customElements.define("cosmoz-dropdown",ve(Ju,{styleSheets:[Wu]}));function Gu(e){return()=>e}const Xu=Gu(),Qu=Xu,Yr=bo(()=>Qu);customElements.define("cosmoz-keybinding-provider",Yr.Provider);const Zu=(e,t)=>{const i=mn(Yr),n=Rr(e);te(()=>i(n),t)};function ed(e){return e.boundingClientRect.height===0}function td(e){return e.getBoundingClientRect().height===0}const id=e=>{if(e.element.tagName!=="SLOT")throw new Error("Overflow directive must be used on a slot element")};function sd(e,t){e.forEach(i=>{td(i)||(t.add(i),e.delete(i))})}const nd=(e,t)=>{let i=new Set,n=new Set,s=new Set,r=new Set;const o=new IntersectionObserver(c=>{c.forEach(u=>{const d=u.target;r.delete(d),u.boundingClientRect.width===u.intersectionRect.width&&u.intersectionRect.height!==0?(i.add(d),n.delete(d),s.delete(d)):ed(u)?(i.delete(d),n.delete(d),s.add(d)):(i.delete(d),n.add(d),s.delete(d))}),sd(s,n),t({visible:i,overflowing:n,hidden:s})},{root:e.parentElement,threshold:[0,.5,1]}),a=c=>{const u={visible:new Set,overflowing:new Set,hidden:new Set,pending:new Set};for(const d of c)i.has(d)?u.visible.add(d):n.has(d)?u.overflowing.add(d):s.has(d)?u.hidden.add(d):(r.has(d)||o.observe(d),u.pending.add(d));return u},l=()=>{const c=Array.from(e.assignedElements({flatten:!0}));({visible:i,overflowing:n,hidden:s,pending:r}=a(c)),r.size===0&&t({visible:i,overflowing:n,hidden:s})};return l(),e.addEventListener("slotchange",l),()=>{e.removeEventListener("slotchange",l),o.disconnect()}};class rd extends bn{observer;slot;cleanup;render(){return He}update(t,[i]){return id(t),this.slot!==t.element&&(this.cleanup&&(this.cleanup(),this.cleanup=void 0),this.slot=t.element,this.cleanup=nd(this.slot,i)),He}}const od=Mt(rd),ad=Nt`
	:host {
		display: block;
		overflow: hidden;
		bottom: 0;
