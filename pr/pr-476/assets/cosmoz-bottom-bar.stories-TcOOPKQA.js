...
`,qO={title:`Cosmoz Bottom Bar`,render:GO,argTypes:{active:{control:`boolean`},maxToolbarItems:{control:`number`}},parameters:{docs:{description:{component:`The Cosmoz Bottom Bar web component`}}}},JO={args:{active:!0,maxToolbarItems:2},parameters:{docs:{description:{story:`The basic version`}}}},YO={render:KO,args:{active:!0,maxToolbarItems:2},parameters:{docs:{description:{story:`The empty cosmoz-bottom-bar`}}}},XO=[{text:`Activate`,group:`Handle`},{text:`Mark as done`,group:`Handle`},{text:`Investigate invoice`,group:`Assign`},{text:`Set invoice flow`,group:`Assign`},{text:`Change buyer`,group:`Edit`},{text:`Change supplier`,group:`Edit`},{text:`Update exchange rate`,group:`Edit`},{text:`Comment`,group:`Communicate`},{text:`Send by email`,group:`Communicate`},{text:`Reindex invoice`,group:`Support`},{text:`Move to archive`,group:`Close`}],customElements.define(`cosmoz-bottom-bar-grouped-story`,M(({active:e,maxToolbarItems:t})=>a`<cosmoz-bottom-bar
                ?active=${e}
                .maxToolbarItems=${t}
            >
                <span slot="info">Grouped menu demo</span>
                ${gt(XO,({text:e,group:t})=>a`<button data-group=${t}>${e}</button>`)}
            </cosmoz-bottom-bar>`,{observedAttributes:[`active`]})),ZO={render:({active:e,maxToolbarItems:t})=>a`<cosmoz-bottom-bar-grouped-story
            ?active=${e}
            .maxToolbarItems=${t}
        ></cosmoz-bottom-bar-grouped-story>`,args:{active:!0,maxToolbarItems:1},parameters:{docs:{description:{story:"Menu items with a different `data-group` than the item above them get a divider"}}}},JO.parameters={...JO.parameters,docs:{...JO.parameters?.docs,source:{originalSource:`{
  args: {
    active: true,
    maxToolbarItems: 2
  },
...
}`,...YO.parameters?.docs?.source}}},ZO.parameters={...ZO.parameters,docs:{...ZO.parameters?.docs,source:{originalSource:`{
  render: ({
    active,
    maxToolbarItems
  ...
  parameters: {
    docs: {
      description: {
        story: 'Menu items with a different \`data-group\` than the item above them get a divider'
      }
    }
  }
}`,...ZO.parameters?.docs?.source}}},QO=[`Basic`,`Empty`,`Grouped`]}))();export{JO as Basic,YO as Empty,ZO as Grouped,QO as __namedExportsOrder,qO as default};