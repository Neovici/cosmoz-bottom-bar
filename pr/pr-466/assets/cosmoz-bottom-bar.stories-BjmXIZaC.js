...
`,WO=Symbol(`openMenu`),GO=e=>{let t=e.shadowRoot?.querySelector(`#dropdown`);!t||t.hasAttribute(`hidden`)||((t.shadowRoot?.querySelector(`cosmoz-dropdown`))?.shadowRoot?.querySelector(`#dropdownButton`))?.click()},KO=e=>e.nodeType===Node.ELEMENT_NODE&&e.getAttribute(`slot`)!==`info`&&e.tagName!==`TEMPLATE`&&e.tagName!==`STYLE`&&e.tagName!==`DOM-REPEAT`&&e.tagName!==`DOM-IF`&&e.getAttribute(`slot`)!==`extra`,qO=e=>{let t=[...e.childNodes],n=[];for(let e of t)if(e.tagName===`SLOT`){let t=e.assignedElements({flatten:!0});n.push(...t)}else n.push(e);return n},JO=e=>{let t=qO(e).filter(KO).filter(e=>!e.hidden).sort((e,t)=>(Number(e.dataset.index)||0)-(Number(t.dataset.index)||0));if(t.length===0)return t;let n=t.reduce((e,t)=>parseInt(e.dataset.priority??`0`,10)>=parseInt(t.dataset.priority??`0`,10)?e:t,{dataset:{priority:`-1000`}});return[n,...t.filter(e=>e!==n)]},YO={variant:`tertiary`,size:`sm`},XO=new WeakMap,ZO=(e,t,n,r)=>{let i=t?VO:HO;e.setAttribute(`slot`,i),e.setAttribute(`tabindex`,`0`),XO.has(e)||XO.set(e,{variant:e.getAttribute(`variant`),size:e.getAttribute(`size`)});let a=t?XO.get(e):YO;Object.entries(a).forEach(([t,n])=>n==null?e.removeAttribute(t):e.setAttribute(t,n)),e.classList.toggle(r,!t),e.classList.toggle(n,t)},QO=(e,t,n)=>{let r=JO(e),{maxToolbarItems:i=1}=e;if(!(r.length>0)){e.toggleAttribute(`has-menu-items`,!1);return}let a=r.slice(0,i),o=r.slice(a.length);a.forEach(e=>ZO(e,!0,t,n)),o.forEach(e=>ZO(e,!1,t,n)),e.toggleAttribute(`has-menu-items`,o.length>0)},$O=e=>{let{active:t=!1,maxToolbarItems:n=1}=e,r=M(!1);UT({activity:WO,callback:()=>GO(e),check:()=>t&&!e.hasAttribute(`hide-actions`),element:()=>e.shadowRoot?.querySelector(`#dropdown`)},[t]);let i=k(()=>Nt(`height`),[]);Ae(()=>{r.current?i(e,t):i(e,t,{duration:0}),r.current=!0},[t]);let o=A(()=>QO(e,`cosmoz-bottom-bar-toolbar`,`cosmoz-bottom-bar-menu`),[n]),s=M(null),c=A(()=>{let t=s.current;t&&(t.disconnect(),qO(e).filter(KO).forEach(e=>{t.observe(e,{attributes:!0,attributeFilter:[`hidden`]})}))},[]);O(()=>{s.current=new MutationObserver(()=>{c(),o()}),c(),o();let t=new MutationObserver(()=>{c(),o()});return t.observe(e,{childList:!0}),()=>{s.current?.disconnect(),s.current=null,t.disconnect()}},[o]);let l=A(()=>{c(),o()},[o]);return a` <div id="bar" part="bar">
		...
		</div>`},customElements.define(`cosmoz-bottom-bar`,N($O,{observedAttributes:[`active`,`max-toolbar-items`],styleSheets:[UO]})),ek=`
	<slot name="extra" slot="extra"></slot>
	<slot name="bottom-bar-toolbar" slot="bottom-bar-toolbar"></slot>
	<slot name="bottom-bar-menu" slot="bottom-bar-menu"></slot>
`,a(Object.assign([ek],{raw:[ek]})),LO(Object.assign([ek],{raw:[ek]}))}));function nk(e){let t=[...e];for(let e=t.length-1;e>0;e--){let n=Math.floor(Math.random()*(e+1));[t[e],t[n]]=[t[n],t[e]]}return t}var rk,ik,ak,ok,sk,ck,lk;e((()=>{kt(),P(),s(),L(),jt(),tk(),rk=e=>{let{active:t,maxToolbarItems:n}=e,[r,i]=j(``),[o,s]=j(nk([{onClick:()=>alert(`Button 1 clicked`),priority:10,text:`Button 1`},{onClick:()=>alert(`Button 2 clicked`),text:`Button 2`},{onClick:()=>alert(`Button 3 clicked`),text:`Button 3`},{onClick:()=>alert(`Button 4 clicked`),priority:5,text:`Button 4`},{onClick:()=>alert(`Button 5 clicked`),text:`Button 5`}].concat(...Array.from({length:100},(e,t)=>{let n=t+6;return{onClick:()=>alert(`Button `+n+` clicked`),text:`Button `+n,priority:n}})))),c=e=>{let t=e.target;i(t.value)},l=e=>{let t=e?e.trim():``;s([...o,{onClick:()=>alert(`!!Button `+t+` clicked`),priority:t?+t:void 0,text:`Button `+t}]),e&&i(``)};return a`
        <input
            .value=${r}
    ...
    `},customElements.define(`cosmoz-bottom-bar-story`,N(rk,{observedAttributes:[`active`,`max-toolbar-items`]})),ik=e=>a`<cosmoz-bottom-bar-story
        ?active=${e.active}
        .maxToolbarItems=${e.maxToolbarItems}
    ></cosmoz-bottom-bar-story>`,ak=({active:e,maxToolbarItems:t})=>a`
    <cosmoz-bottom-bar
        id="bottomBar"
        ?active=${e}
        .maxToolbarItems=${t}
...
`,ok={title:`Cosmoz Bottom Bar`,render:ik,argTypes:{active:{control:`boolean`},maxToolbarItems:{control:`number`}},parameters:{docs:{description:{component:`The Cosmoz Bottom Bar web component`}}}},sk={args:{active:!0,maxToolbarItems:2},parameters:{docs:{description:{story:`The basic version`}}}},ck={render:ak,args:{active:!0,maxToolbarItems:2},parameters:{docs:{description:{story:`The empty cosmoz-bottom-bar`}}}},sk.parameters={...sk.parameters,docs:{...sk.parameters?.docs,source:{originalSource:`{
  args: {
    active: true,
    maxToolbarItems: 2
  },
...
}`,...sk.parameters?.docs?.source}}},ck.parameters={...ck.parameters,docs:{...ck.parameters?.docs,source:{originalSource:`{
...
}`,...ck.parameters?.docs?.source}}},lk=[`Basic`,`Empty`]}))();export{sk as Basic,ck as Empty,lk as __namedExportsOrder,ok as default};